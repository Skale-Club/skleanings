...
<details>
<summary>✅ v7.0 Xkedule Foundation (Phases 36–37) — SHIPPED 2026-05-13</summary>

- [x] Phase 36: Locale Settings (3/3 plans) — completed 2026-05-13
- [x] Phase 37: Super-Admin Panel (3/3 plans) — completed 2026-05-13
...
<details>
<summary>✅ v8.0 Multi-Tenant Architecture (Phases 38–41) — SHIPPED 2026-05-13</summary>

- [x] Phase 38: Schema Foundation (2/2 plans) — completed 2026-05-13
- [x] Phase 39: Storage Refactor (3/3 plans) — completed 2026-05-13
- [x] Phase 40: Tenant Resolution Middleware (3/3 plans) — completed 2026-05-13
- [x] Phase 41: Infra Config (2/2 plans) — completed 2026-05-13
...
<details>
<summary>✅ v9.0 Tenant Onboarding (Phases 42–44) — SHIPPED 2026-05-14</summary>

- [x] Phase 42: Tenant Management UI (3/3 plans) — completed 2026-05-14
- [x] Phase 43: Tenant Provisioning (3/3 plans) — completed 2026-05-14
- [x] Phase 44: Isolation Verification (2/2 plans) — completed 2026-05-14
...
<details>
<summary>✅ v10.0 Tenant Admin Auth (Phases 45–46) — SHIPPED 2026-05-14</summary>

- [x] Phase 45: Tenant Admin Auth Backend (2/2 plans) — completed 2026-05-14
- [x] Phase 46: Admin Panel Frontend Auth (1/1 plans) — completed 2026-05-14
...
**Goal**: The database has complete multi-tenant schema — tenants, domains, and userTenants tables exist, every business table carries a tenantId column, and Skleanings is seeded as tenant 1 with all existing data owned by that tenant
**Depends on**: Phase 37
...
**Depends on**: Phase 38
**Requirements**: MT-06, MT-07, MT-08
**Success Criteria** (what must be TRUE):
...
**Depends on**: Phase 39
**Requirements**: MT-09, MT-10, MT-11, MT-12, MT-13
**Success Criteria** (what must be TRUE):
  1. A request with an unknown hostname (not in the `domains` table) receives a 404 response before reaching any business route handler
  2. The second request for the same hostname does not hit the database — it is served from the LRU cache (max 500 entries, 5-minute TTL)
...
**Depends on**: Phase 40
**Requirements**: MT-14, MT-15, MT-16, MT-17
**Success Criteria** (what must be TRUE):
  1. `infra/Caddyfile` exists and configures Caddy to reverse-proxy `*.xkedule.com` wildcard and custom tenant domains to the Node process
...
- [x] 50-02-PLAN.md — /admin/billing page (BillingPage.tsx): status card, renewal date, Manage Billing button wired to portal endpoint
**UI hint**: yes
...
**Plans**: 2 plans
Plans:
- [x] 53-01-PLAN.md — Billing email notifications: trial_will_end + past_due webhook sends (BH-01, BH-02, BH-03)
...
**Plans**: 2 plans
Plans:
- [x] 54-01-PLAN.md — GET /api/billing/invoices backend endpoint (BH-06)
...
**Plans**: 3 plans
Plans:
- [x] 55-01-PLAN.md — DB migration + Drizzle schema + IStorage methods (OB-03)
...
- [x] 57-03-PLAN.md -- GET /auth/validate-invite + POST /auth/accept-invite (SF-03, SF-04)
...
- [x] 59-03-PLAN.md — Webhook tier mapping + PATCH /tenants/:id/plan endpoint (PT-04, PT-05)
...
**Plans**: 2 plans
- [x] 60-01-PLAN.md — /admin/billing tier badge + features list (PT-06)
...
- [x] 62-02-PLAN.md — Super-admin ManageDomainsDialog: Status column + destructive confirm for unverified domains (CD-09)
**UI hint**: yes
...
**Plans**: 3 plans
  ...
  - [x] 65-03-PLAN.md — Webhook Connect routing + fee breakdown persistence (PF-05, PF-06)
**UI hint**: no
