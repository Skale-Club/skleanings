...
- [x] **OB-04**: Admin pages show a dismissible yellow banner "Please verify your email — check your inbox" when `emailVerifiedAt` is null — the banner includes a "Resend verification email" link that calls `POST /api/auth/resend-verification`
